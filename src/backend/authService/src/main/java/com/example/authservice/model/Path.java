...
public class Path {
  ...
  public static final String V1_EMPLOYEES_ANYONE_ROLES =
      V1_EMPLOYEES_ANYONE + ROLES;
  public static final String V1_EMPLOYEES_ANYONE_PASSWORD =
      V1_EMPLOYEES_ANYONE + PASSWORD;
  public static final String V1_EMPLOYEES_ANYONE_ENABLE =
      V1_EMPLOYEES_ANYONE + ENABLE;
