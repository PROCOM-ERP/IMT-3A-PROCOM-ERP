...
import com.example.inventoryservice.annotation.LogError;
...
import com.example.inventoryservice.annotation.LogMessageSent;
...
public class CustomLoggingAspect {
    ...
    @Around("@annotation(com.example.inventoryservice.annotation.LogExecutionTime)")
    ...
    @Before("@annotation(com.example.inventoryservice.annotation.LogMessageSent)")
    ...
    @Before("@annotation(com.example.inventoryservice.annotation.LogMessageReceived)")
    ...
    @After("@annotation(com.example.inventoryservice.annotation.LogError)")
