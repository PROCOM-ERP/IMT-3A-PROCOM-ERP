...
public enum Endpoint {
  ...
  GET_V1_EMPLOYEES(HttpMethod.GET,
          Path.V1_EMPLOYEES,
          Permission.CanReadEmployee),
  GET_V1_EMPLOYEES_ID(HttpMethod.GET,
          Path.V1_EMPLOYEES_ANYONE,
          Permission.CanReadEmployee),
  GET_V1_EMPLOYEES_ID_ENABLE(HttpMethod.GET,
          Path.V1_EMPLOYEES_ANYONE_ENABLE,
          Permission.CanReadEmployee),
  POST_V1_EMPLOYEES(HttpMethod.POST,
          Path.V1_EMPLOYEES,
          Permission.CanCreateEmployee),
  PATCH_V1_EMPLOYEES_ROLES(HttpMethod.PATCH,
          Path.V1_EMPLOYEES_ANYONE_ROLES,
          Permission.CanModifyEmployeeRoles),
  PATCH_V1_EMPLOYEES_PASSWORD(HttpMethod.PATCH,
          Path.V1_EMPLOYEES_ANYONE_PASSWORD,
          Permission.CanModifyEmployeePassword),
  PATCH_V1_EMPLOYEES_ENABLE(HttpMethod.PATCH,
          Path.V1_EMPLOYEES_ANYONE_ENABLE,
          Permission.CanDeactivateEmployee),
  PATCH_V1_EMPLOYEES_EMAIL(HttpMethod.PATCH,
          Path.V1_EMPLOYEES_ANYONE_EMAIL,
