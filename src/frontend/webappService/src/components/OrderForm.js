  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <div>
            <p>Name: {ordererInfo.lastName} {ordererInfo.firstName}</p>
          </div>
          <label htmlFor="number">Number:</label>
          <input type="text" id="number" name="number" value={orderData.address.number} onChange={handleAddressChange} />
          <label htmlFor="street">Street:</label>
          <input type="text" id="street" name="street" value={orderData.address.street} onChange={handleAddressChange} />
          <label htmlFor="city">City:</label>
          <input type="text" id="city" name="city" value={orderData.address.city} onChange={handleAddressChange} />
          <label htmlFor="state">State:</label>
          <input type="text" id="state" name="state" value={orderData.address.state} onChange={handleAddressChange} />
          <label htmlFor="country">Country:</label>
          <input type="text" id="country" name="country" value={orderData.address.country} onChange={handleAddressChange} />
          <label htmlFor="zipcode">Zip code:</label>
          <input type="text" id="zipcode" name="zipcode" value={orderData.address.zipcode} onChange={handleAddressChange} />
          <label htmlFor="info">Information:</label>
          <input type="text" id="info" name="info" value={orderData.address.info} onChange={handleAddressChange} />
        </div>
